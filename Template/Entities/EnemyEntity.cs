...
namespace Template.Entities
{
    public class EnemyEntity : Entity
    {
        public EnemyEntity(TextureHandler textureHandler)
        {
            ...
            //collider.Offset = new Point(2, 0);
            //collider.Bounds = new Rectangle((int)Math.Round(transform.Position.X + collider.Offset.X), (int)Math.Round(transform.Position.Y + collider.Offset.Y), GameSettings.TileSize - 4, GameSettings.TileSize + 1);
